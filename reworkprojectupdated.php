...
require('connect.php');
	...
	$statusquery = mysqli_query($connection, "SELECT a.jobid, b.jobname, a.templatedate, a.workorderdate, a.materialdate, a.sinkdate, a.fabdate, a.installeddate, a.billeddate, b.installdate
