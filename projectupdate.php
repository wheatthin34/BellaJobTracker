...
$statusquery = mysqli_query($connection, "SELECT a.*, DATE(b.installdate) AS installdatetouse, b.*, c.*
...
while ($result = mysqli_fetch_array($statusquery, MYSQLI_ASSOC)){
	...
	$installdate = $result['installdatetouse'];
	//$formatdate = date("m/d/Y", $installdate);
	//$formatdate = $installdate->format('m/d/Y');
        ...
        <div class="container">
            <div class="row text-black">
                <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 mx-auto text-center form p-1">
					...
					<input type="text" style="text-align:center; font-size: 25px; width: 100%" name='project' id='project' value="<?php echo $jobname?>">
					<br><br>
								<div class="col"><h4>Install Date: </h4>
								<input style="text-align: center" type="date" value="<?php echo $installdate; ?>" name="installdate" id="installdate">
								<button type="button" class="btn btn-danger" onClick="window.location.href='<?php echo "deletedate.php?jobid=$rcvdjobid" ?>'">X</button>
