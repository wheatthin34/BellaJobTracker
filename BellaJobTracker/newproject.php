            ...
            <div class="row text-black">
                <div class="col-xl-5 col-lg-6 col-md-8 col-sm-10 mx-auto text-center form p-1">
					...
					<h3>New Project Request</h3>
                        <form id="newprojectform" action="projectsubmit.php" method="post" class="justify-content-center">
								<div class="form-group">
									<label class="sr-only">Project</label>
									<input type="text" class="form-control" placeholder="Project Name" name="project" id="project" required>
								</div>	
								<div class="form-group">
									Install Date:
									<input type="date" class="form-control" placeholder="Install Date" name="installdate" id="installdate" required>
								</div>
								<div class="form-group">
