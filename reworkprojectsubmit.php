...
if ($_POST['project']) {
	...
	if ($installdate != ''){
		...
		$Sql = "INSERT INTO projectdetails (jobflag, deleteflag, reworkflag, originaljobid, jobname, installdate, notes) 
				VALUES ('1', '0', '1', '0', '$project', '$installdate', '$notes');";
		}
		else {
			$Sql = "INSERT INTO projectdetails (jobflag, deleteflag, reworkflag, originaljobid, jobname, installdate, notes) 
			VALUES ('1', '0', '1', '0', '$project', NULL, '$notes');";
		}			
